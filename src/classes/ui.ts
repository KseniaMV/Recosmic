...
export class Hud {
    ...
    constructor (scene: Scene) {
        ...
        const sparklerLife = new Image("sparkLife", "../assets/sprites/sparkLife.png");
        ...
        const spark = new Image("spark", "../assets/sprites/spark.png");
        spark.width = "40px";
        spark.height = "40px";
        spark.cellId = 0;
        spark.cellHeight = 20;
        ...
        const pauseBtn = Button.CreateImageOnlyButton("pauseBtn", "../assets/sprites/pauseBtn.png");
        pauseBtn.width = "48px";
        ...
        let movementPC = new Image("pause", "../assets/sprites/tutorial.jpeg");
        ...
        const lanternHint = new Image("lantern1", "../assets/sprites/arrowBtn.png");
        ...
        if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
            ...
            let movementMobile = new Image("pause", "../assets/sprites/tutorialMobile.jpeg");
            ...
            const dashBtn = Button.CreateImageOnlyButton("dash", "../assets/sprites/aBtn.png");
            dashBtn.thickness = 0;
            dashBtn.alpha = 0.8;
            dashBtn.horizontalAlignment = Control.HORIZONTAL_ALIGNMENT_RIGHT;
            this.dashBtn = dashBtn;

            const jumpBtn = Button.CreateImageOnlyButton("jump", "../assets/sprites/bBtn.png");
            jumpBtn.thickness = 0;
            jumpBtn.alpha = 0.8;
            ...
            const leftBtn = Button.CreateImageOnlyButton("left", "../assets/sprites/arrowBtn.png");
            leftBtn.thickness = 0;
            ...
            const rightBtn = Button.CreateImageOnlyButton("right", "../assets/sprites/arrowBtn.png");
            ...
            const upBtn = Button.CreateImageOnlyButton("up", "../assets/sprites/arrowBtn.png");
            upBtn.thickness = 0;
            upBtn.alpha = 0.8;
            upBtn.color = "white";
            this.upBtn = upBtn;

            const downBtn = Button.CreateImageOnlyButton("down", "../assets/sprites/arrowBtn.png");
            downBtn.thickness = 0;
    ...
    private _createPauseMenu(): void {
        ...
        //background image
        const image = new Image("pause", "../assets/sprites/pause.jpeg");
    ...
    private _createControlsMenu(): void {
        ...
        const backBtn = Button.CreateImageOnlyButton("back", "../assets/sprites/lanternbutton.jpeg");
        backBtn.width = "40px";
        backBtn.height = "40px";
        backBtn.top = "14px";
        backBtn.thickness = 0;
    ...
    private _loadSounds(scene: Scene): void {
        this._pause = new Sound("pauseSong", "../assets/sounds/click.wav", scene, function () {
        }, {
            volume: 0.2
        });

        this._sfx = new Sound("selection", "../assets/sounds/click.wav", scene, function () {
        });

        this.quitSfx = new Sound("quit", "../assets/sounds/click.wav", scene, function () {
        });

        this._sparkWarningSfx = new Sound("sparkWarning", "../assets/sounds/click.wav", scene, function () {
        }, {
            loop: false,
            volume: 0.5,
            playbackRate: 0.6
